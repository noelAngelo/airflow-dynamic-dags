            ...
            "attachments":[
                {
                    ...
                    "content":{
                        ...
                        "body":[
                            ...
                            {
                                "type": "TextBlock",
                                "text": "Fleetsu Orchestration Results",
                                "wrap": "true",
                                "size": "large",
                                "style": "heading"
                            },
...
# DAG config -- default
DAG_OWNER = 'airflow'
DAG_START_DATE_YEAR = 2023
DAG_START_DATE_MONTH = 8
DAG_START_DATE_DAY = 15
DAG_RETRIES = 1

# Task config -- Databricks
DATABRICKS_CONN_ID: str = 'databricks_default'
DATABRICKS_JOB_NAME: str = 'bronze_fleetsu_ingestion_workflow'
DATABRICKS_JOB_ID: int = None
DATABRICKS_NOTEBOOK_PARAMS: dict = None
...
DBT_JOB_NAME: str = 'bronze_fleetsu_processing_job'
DBT_JOB_ID: int = None
...
def send_teams_message(databricks_workflow_id, dbt_job_id, dbt_project_id):
    hook = MSTeamsWebhookHook(teams_conn_id='msteams_default')
